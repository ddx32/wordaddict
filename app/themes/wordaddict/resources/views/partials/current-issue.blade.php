...
<section class="latest-issue" style="background-image: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url({{ get_field('main_artwork')['sizes']['huge'] }})">
  <div class="latest-issue-content">
    ...
    <div class="latest-issue-teaser">
      ...
      <h2 class="latest-issue-h2">
        <a href="{{ the_permalink() }}" class="latest-issue-name">{{ the_title() }}</a>
      </h2>
